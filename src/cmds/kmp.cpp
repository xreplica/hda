 ...
 * $Revision: 38 $
 * $URL: https://127.0.0.1:10000/svn/hda/trunk/src/cmds/kmp.cpp $
 */
...
int main(int argc, const char* argv[])
{
    ...
    KMeansPlus kmp(filename, vDimension);
    kmp.run(numClust);
    ...
    if(displayIndexes)
    {
        cout<<"Xie-Beni index(-): "<<Validation::xieBeniIndex(kmp.clusterSet(), kmp.pointSet(), kmp.U(), 1)<<endl;
        cout<<"Fukuyama-Sugeno index(-): "<<Validation::fukuyamaSugenoIndex(kmp.clusterSet(), kmp.pointSet(), kmp.U(), 1)<<endl;
        cout<<"Kwon index(-): "<<Validation::kwonIndex(kmp.clusterSet(), kmp.pointSet(), kmp.U(), 1)<<endl;
        cout<<"CWB index*(-): "<<Validation::composeWithinBetweenIndex(kmp.clusterSet(), kmp.pointSet(), kmp.U(), 1)<<endl;
        //cout<<"Zahid index*(+): "<<Validation::zahidIndex(kmp.clusterSet(), kmp.pointSet(), kmp.U(), 1)<<endl;
        //cout<<"Fuzzy Hypervolume*(-): "<<Validation::fuzzyHypervolume(kmp.clusterSet(), kmp.pointSet(), kmp.U(), atoi(argv[4]))<<endl;
        cout<<"PBM index*(+): "<<Validation::PBMIndex(kmp.clusterSet(), kmp.pointSet(), kmp.U())<<endl;
        cout<<"Silhouette index(+): "<<Validation::silhouette(kmp.clusterSet(), kmp.pointSet())<<endl;
    }
